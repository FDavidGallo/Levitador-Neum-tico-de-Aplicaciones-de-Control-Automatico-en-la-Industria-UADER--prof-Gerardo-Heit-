...
void loop() {
    ...
    if (maxDistancia > minDistancia) {
        porcentaje = (((100.0 * (distanciaFiltrada - minDistancia) / (maxDistancia - minDistancia))) * (100.0));

        porcentaje = constrain(porcentaje, 0, 10000);
        porcentaje=(porcentaje/((1238-360)))*100.0-20;
    ...
    Serial.println(porcentaje, 2);         // 2 decimales
