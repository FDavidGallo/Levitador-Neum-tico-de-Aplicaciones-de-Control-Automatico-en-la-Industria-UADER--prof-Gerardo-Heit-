...
const unsigned long calibZeroTime = 10000;    // 50 segundos
const unsigned long calibMaxTime = 10000;     // 60 segundos
const unsigned long postCalibTime = 10000;    // 60 segundos después de calibración
